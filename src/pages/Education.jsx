          ...
          <div className="edu-content">
            <div className="thesis-section">
              ...
              <p className="thesis-title">
                主要研究方向為深度學習、時間序列預測與海洋資料分析，參與國科會計畫「建置創新海上箱網養殖平台與監控系統--子計畫二」。碩士論文聚焦於結合變分模態分解(VMD)與 Transformer-LSTM 混合架構進行海洋有效波高預測，透過 VMD 技術將複雜波浪訊號分解為多個頻率分量，並針對各模態建立獨立預測模型。提出改良的 Transformer 架構，分別捕捉長短期時間依賴特徵，實現 48 小時長期預測。
              </p>
            </div>
          </div>
        </div>
